...
/**
 * @Description: 通用的redis数据的操作以及针对message封装的操作
 * key设计
 * 关系型数据库的redis
 * 1: 把表名转换为key前缀 如, tag:
...
//        return (Object) redisObjectTemplate.opsForValue().get(key);
//    }
    ...
    public void expireKey(String key, long time, TimeUnit timeUnit) {
        log.info("设置{}的生命周期: time:{},timeUnit:{}", key, time, timeUnit);
