...
public class StudentServiceImpl implements StudentService {
     ...
     * 过期时间
     */
    private static final long expires_time = 3600;
    private static final long expires_time1 = 10;
    private static final long expires_time2 = 20;
    ...
    public List<Student> selectAll() {
        ...
        try {
            ...
            System.out.println("StudentServiceImpl.selectAll() : 从数据库取得数据，条数：" + list.size());
            String toJson = new Gson().toJson(list);
            // 存在到缓存中
            operations.set(key, toJson, expires_time1, TimeUnit.SECONDS);
            return list;
    ...
    public Student getStudent(String numberCode) {
        ...
        // 插入缓存中
        operations.set(key, str, expires_time, TimeUnit.SECONDS);
